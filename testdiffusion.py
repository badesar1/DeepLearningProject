...
def main():
    ...
    files_source = glob.glob(os.path.join(opt.test_data, '7000-01_HARDI64axis*7000.nii'))
    files_source.sort()
...
#                plt.show()
        ...
        ni.save(niout, os.path.join(opt.test_data, fname + '_dncnnS25.nii'))
        niout = ni.Nifti1Image(NoiseImg, nii.affine, nii.header)
        ni.save(niout, os.path.join(opt.test_data, fname + '_dncnnS25_noisemap.nii'))
